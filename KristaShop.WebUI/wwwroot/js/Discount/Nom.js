    ...
    var table = $('#nom-table').DataTable({
        ...
        "columns": [
            ...
            },
            {
                ...
                "width": "10%",
                "render": function (data, type, full, meta) {
                    return '<a href="/Discount/IndexType?discountId=' + data + '&discountType=2" class="btn btn-sm btn-info"><i class="fas fa-percent"></i> Скидка</a>';
                }
            }
        ],
        "destroy": true,
